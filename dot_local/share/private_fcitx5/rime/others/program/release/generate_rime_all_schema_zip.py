...
for file_name in file_names:
    ...
    if (
        ...
        and ".userdb" not in file_name
        and ".git" not in file_name
        and ".idea" not in file_name
        and ".zip" not in file_name
        and "custom" not in file_name
    ):
