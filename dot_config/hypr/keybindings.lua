...
local moveactivewindow_cmd =
    [[test "$(hyprctl activewindow -j | jq -r .floating)" = "true" && hyprctl dispatch moveactive]]
...
hl.bind("SUPER + CTRL + H", hl.dsp.group.move_window({ action = "b" }))  -- b=back, f=forward
hl.bind("SUPER + CTRL + L", hl.dsp.group.move_window({ action = "f" }))
...
hl.bind(
    "SUPER + SHIFT + CTRL + H",
    hl.dsp.exec_cmd(moveactivewindow_cmd .. " -30 0 || hyprctl dispatch movewindow l"),
    { repeating = true }
)
hl.bind(
    "SUPER + SHIFT + CTRL + L",
    hl.dsp.exec_cmd(moveactivewindow_cmd .. " 30 0 || hyprctl dispatch movewindow r"),
    { repeating = true }
)
hl.bind(
    "SUPER + SHIFT + CTRL + K",
    hl.dsp.exec_cmd(moveactivewindow_cmd .. " 0 -30 || hyprctl dispatch movewindow u"),
    { repeating = true }
)
hl.bind(
    "SUPER + SHIFT + CTRL + J",
    hl.dsp.exec_cmd(moveactivewindow_cmd .. " 0 30 || hyprctl dispatch movewindow d"),
    { repeating = true }
)
